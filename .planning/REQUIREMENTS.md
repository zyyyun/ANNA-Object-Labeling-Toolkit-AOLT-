...
- [ ] **USAB-09**: Waypoint 선택 상태에서 Entry/Exit 버튼이 해당 Waypoint의 Entry/Exit 프레임으로 즉시 이동 (기존 프레임 지정 기능과 분기)
...
- [ ] **RELI-06**: 영상 최초 로드 중 타임라인 상호작용 가드 (로드 완료 전 클릭/드래그 무시, Person/Vehicle 수동 추적 경합 방지)
...
| USAB-09 | Phase 5.5 | Pending |
| RELI-06 | Phase 5.5 | Pending |
